        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <p className="mt-2 text-3xl leading-8 font-extrabold tracking-tight text-gray-900 sm:text-4xl">
              Hi, I'm Deepak Dharmode
            </p>
            <p className="mt-4 max-w-2xl text-xl text-gray-500 lg:mx-auto">
              A Full-Stack Developer with expertise in web development, Design,
              and the MERN stack.
            </p>
          </div>
          <div className="mt-10">
            <div className="grid grid-cols-1 gap-12 lg:grid-cols-2">
              <div>
                ...
                <p className="mt-4 text-lg text-gray-600">
                  ...
                  Drone Food delivary, and even a clone. My projects demonstrate
          ...
          <div className="mt-12">
            ...
            <p className="mt-4 text-lg text-gray-600">
              Beyond coding, I am passionate about learning new technologies and
              keeping myself up-to-date with the latest trends in web
              development. I find inspiration in the thrill of football⚽, the
              mysteries of the cosmos, and the adventures of hiking and camping.
              Whether it's solving complex UI challenges or exploring the great
              outdoors, I bring the same energy, curiosity, and dedication to
              everything I do🚀🔥.
            </p>
          </div>
        </div>
